...
if strcmp(ele_type,'wall') && strcmp(direction,'primary')
    ...
    scatter(side_1_id(side_1.damage_recorded == 1),side_1.d_ratio(side_1.damage_recorded == 1), 'o', 'filled', 'MarkerEdgeColor', 'y', 'MarkerFaceColor', 'y' )
    ...
    scatter(side_2_id(side_2.damage_recorded == 1),side_2.a_ratio(side_2.damage_recorded == 1), 'd', 'filled', 'MarkerEdgeColor', 'y', 'MarkerFaceColor', 'y' )
...
if strcmp(ele_type,'wall') && strcmp(direction,'primary')
    ...
    scatter(side_1_id(side_1.damage_recorded == 1),side_1.e_ratio(side_1.damage_recorded == 1), 'o', 'filled', 'MarkerEdgeColor', 'y', 'MarkerFaceColor', 'y' )
    ...
    scatter(side_2_id(side_2.damage_recorded == 1),side_2.b_ratio(side_2.damage_recorded == 1), 'd', 'filled', 'MarkerEdgeColor', 'y', 'MarkerFaceColor', 'y' )
...
scatter(side_1_id(side_1.damage_recorded == 1),side_1.V_ratio(side_1.damage_recorded == 1), 'o', 'filled', 'MarkerEdgeColor', 'y', 'MarkerFaceColor', 'y' )
...
scatter(side_2_id(side_2.damage_recorded == 1),side_2.V_ratio(side_2.damage_recorded == 1), 'd', 'filled', 'MarkerEdgeColor', 'y', 'MarkerFaceColor', 'y' )
