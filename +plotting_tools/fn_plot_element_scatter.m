...
if strcmp(ele_type,'wall') && strcmp(direction,'primary')
    scatter(side_1_id(side_1.damage_recorded == 2),side_1.d_ratio(side_1.damage_recorded == 2), 'o', 'filled', 'MarkerEdgeColor', 'r', 'MarkerFaceColor', 'r' )
    scatter(side_1_id(side_1.damage_recorded == 1),side_1.d_ratio(side_1.damage_recorded == 1), 'o', 'filled', 'MarkerEdgeColor', 'm', 'MarkerFaceColor', 'm' )
    ...
    scatter(side_2_id(side_2.damage_recorded == 1),side_2.d_ratio(side_2.damage_recorded == 1), 'd', 'filled', 'MarkerEdgeColor', 'm', 'MarkerFaceColor', 'm' )
    ...
    scatter(side_1_id(side_1.damage_recorded == 1),side_1.a_ratio(side_1.damage_recorded == 1), 'o', 'filled', 'MarkerEdgeColor', 'm', 'MarkerFaceColor', 'm' )
    ...
    scatter(side_2_id(side_2.damage_recorded == 2),side_2.a_ratio(side_2.damage_recorded == 2), 'd', 'filled', 'MarkerEdgeColor', 'r', 'MarkerFaceColor', 'r' )
    scatter(side_2_id(side_2.damage_recorded == 1),side_2.a_ratio(side_2.damage_recorded == 1), 'd', 'filled', 'MarkerEdgeColor', 'm', 'MarkerFaceColor', 'm' )
...
plot([0.5,height(side_1)+height(side_2)+0.5],[1,1],'--k')
if strcmp(ele_type,'wall') && strcmp(direction,'primary')
    scatter(side_1_id(side_1.damage_recorded == 2),side_1.e_ratio(side_1.damage_recorded == 2), 'o', 'filled', 'MarkerEdgeColor', 'r', 'MarkerFaceColor', 'r' )
    scatter(side_1_id(side_1.damage_recorded == 1),side_1.e_ratio(side_1.damage_recorded == 1), 'o', 'filled', 'MarkerEdgeColor', 'm', 'MarkerFaceColor', 'm' )
    ...
    scatter(side_2_id(side_2.damage_recorded == 1),side_2.e_ratio(side_2.damage_recorded == 1), 'd', 'filled', 'MarkerEdgeColor', 'm', 'MarkerFaceColor', 'm' )
    ...
    scatter(side_1_id(side_1.damage_recorded == 1),side_1.b_ratio(side_1.damage_recorded == 1), 'o', 'filled', 'MarkerEdgeColor', 'm', 'MarkerFaceColor', 'm' )
    ...
    scatter(side_2_id(side_2.damage_recorded == 2),side_2.b_ratio(side_2.damage_recorded == 2), 'd', 'filled', 'MarkerEdgeColor', 'r', 'MarkerFaceColor', 'r' )
    scatter(side_2_id(side_2.damage_recorded == 1),side_2.b_ratio(side_2.damage_recorded == 1), 'd', 'filled', 'MarkerEdgeColor', 'm', 'MarkerFaceColor', 'm' )
...
hold on
plot([0.5,height(side_1)+height(side_2)+0.5],[1,1],'--k')
scatter(side_1_id(side_1.damage_recorded == 2),side_1.V_ratio(side_1.damage_recorded == 2), 'o', 'filled', 'MarkerEdgeColor', 'r', 'MarkerFaceColor', 'r' )
scatter(side_1_id(side_1.damage_recorded == 1),side_1.V_ratio(side_1.damage_recorded == 1), 'o', 'filled', 'MarkerEdgeColor', 'm', 'MarkerFaceColor', 'm' )
...
scatter(side_2_id(side_2.damage_recorded == 2),side_2.V_ratio(side_2.damage_recorded == 2), 'd', 'filled', 'MarkerEdgeColor', 'r', 'MarkerFaceColor', 'r' )
scatter(side_2_id(side_2.damage_recorded == 1),side_2.V_ratio(side_2.damage_recorded == 1), 'd', 'filled', 'MarkerEdgeColor', 'm', 'MarkerFaceColor', 'm' )
