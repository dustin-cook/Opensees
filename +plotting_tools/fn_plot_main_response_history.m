...
if exist('record_edp','var')
    ...
    fn_plot_response_history( second_center_id_TH.nd_TH.disp_x_TH/second_floor_ht, second_center_id_TH.nd_TH.disp_z_TH/second_floor_ht, eq_analysis_timespace, eq, eq_dt, rh_plot_dir, 'Second Floor Drift Center (in)', max_time2plot, record_edp.drift_TH_second )
    ...
    fn_plot_response_history( roof_center_id_TH.nd_TH.disp_x_TH, roof_center_id_TH.nd_TH.disp_z_TH, eq_analysis_timespace, eq, eq_dt, rh_plot_dir, 'Roof Displacement Center (in)', max_time2plot, record_edp.disp_TH_roof )
    fn_plot_response_history( roof_center_id_TH.nd_TH.disp_x_TH/roof_ht, roof_center_id_TH.nd_TH.disp_z_TH/roof_ht, eq_analysis_timespace, eq, eq_dt, rh_plot_dir, 'Roof Drift Center (in)', max_time2plot, record_edp.drift_TH_roof )
    fn_plot_response_history( roof_center_id_TH.nd_TH.accel_x_abs_TH, roof_center_id_TH.nd_TH.accel_z_abs_TH, eq_timespace, eq, eq_dt, rh_plot_dir, 'Roof Acceleration Center (g)', max_time2plot, record_edp.accel_TH_roof)
    
    % East side z roof response
    fn_plot_response_history( roof_east_id_TH.nd_TH.disp_z_TH, [], eq_analysis_timespace, eq, eq_dt, rh_plot_dir, 'Roof Displacement East (in)', max_time2plot, record_edp.disp_TH_roof_east.z )
    fn_plot_response_history( roof_east_id_TH.nd_TH.accel_z_abs_TH, [], eq_timespace, eq, eq_dt, rh_plot_dir, 'Roof Acceleration East (g)', max_time2plot, record_edp.accel_TH_roof_east.z )
    % East side z first story response
    fn_plot_response_history( second_east_id_TH.nd_TH.disp_z_TH, [], eq_analysis_timespace, eq, eq_dt, rh_plot_dir, 'Second Floor Displacement East (in)', max_time2plot, record_edp.disp_TH_second_east.z )
    fn_plot_response_history( second_east_id_TH.nd_TH.accel_z_abs_TH, [], eq_timespace, eq, eq_dt, rh_plot_dir, 'Second Floor Acceleration East (g)', max_time2plot, record_edp.accel_TH_second_east.z )
    ...
    fn_plot_response_history( relative_torsional_displacement, [], eq_analysis_timespace, eq, eq_dt, rh_plot_dir, 'Roof Twist (in)', max_time2plot, record_torsional_displacement)
    ...
    fn_plot_response_history( relative_torsional_displacement, [], eq_analysis_timespace, eq, eq_dt, rh_plot_dir, ['1st Story Twist (in)'], max_time2plot, record_torsional_displacement)
    % Torsional Response 1st story
    ...
    fn_plot_response_history( relative_torsional_displacement, [], eq_analysis_timespace, eq, eq_dt, rh_plot_dir, ['1st Story Twist Drift (rad)'], max_time2plot, record_torsional_displacement)
else
