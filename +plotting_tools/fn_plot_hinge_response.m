        ...
        if exist([read_dir filesep 'hinge_TH_' num2str(hinge.id(i)) '.mat'],'file')
            ...
            if strcmp(hinge.type(i),'rotational')
                ...
                if exist('eq_analysis_timespace','var')
                    ...
                    hist_plot = plot(eq_analysis_timespace(1:length(hin_TH.deformation_TH)),hin_TH.deformation_TH,'b','LineWidth',1,'DisplayName','Analysis');
            ...
            elseif strcmp(hinge.type(i),'shear')
                ...
                fn_plot_backbone( ele, ele_side, ele_props, read_dir, hinge_plot_dir, plot_name, 2, hin_TH.deformation_TH, hin_TH.shear_TH, crit_mode, hinge.direction{i})
            end
        end
    end
end
