function [ ele, ele_TH, ele_PM ] = main_element_capacity( ele, ele_prop, ele_TH )
...
if strcmp(ele.type,'column')
    [ ele.Vn, ele.V0 ] = fn_shear_capacity( ele_prop.Av, ele_prop.fy_e, ele_prop.As_d, ele_prop.S, ele_prop.lambda, ele_prop.fc_e, ele_prop.a, ele_TH.M_TH_1, ele_TH.V_TH_1, ele.P_grav, ele.DCR_total_raw );
    ele.Vs = NaN;
else
