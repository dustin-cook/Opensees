function [ node, ground_motion ] = main_write_tcl( model, output_dir, node, element, story, joint, hinge, analysis, truss )
...
if strcmp(model.dimension,'2D')
    [ node ] = fn_build_model_2D( output_dir, node, element, joint, hinge, analysis, truss );
...
fn_define_recorders( output_dir, model.dimension, node.id', element, hinge, analysis )
