...
elseif strcmp(analysis.proceedure,'Pushover')
    ...
    analysis.pushover_drift_list_x = [0.009, 0.009]; % Drift limit where the pushover will go till
...
%     analysis.damp_ratio_list = [0.03, 0.03, 0.03, 0.03, 0.03]; % Analysis damping ratio
    ...
    analysis.pushover_drift_list_x = [0.01, 0.01, NaN]; % Drift limit where the pushover will go till
    analysis.pushover_drift_list_z = [0.005 0.005, NaN];
