...
analysis.ground_motion_scale_factor = 3; % Scale the GM amplitude
...
if strcmp(analysis.proceedure,'test')
    ...
    analysis.pushover_drift_list_x = [0.01, 0.015];
    analysis.pushover_drift_list_z = [0.01, 0.015];
...
elseif strcmp(analysis.proceedure,'Pushover')
    ...
    analysis.pushover_drift_list_x = [0.02, 0.02]; % Drift limit where the pushover will go till
    analysis.pushover_drift_list_z = [0.02 0.02];
    analysis.accidental_torsion_list = [0, 0];
    analysis.damp_ratio_list = [0.03, 0.03]; % Analysis damping ratio
...
%     analysis.damp_ratio_list = [0.03, 0.03, 0.03, 0.03, 0.03]; % Analysis damping ratio
    ...
    analysis.pushover_drift_list_x = [0.012, 0.012, NaN]; % Drift limit where the pushover will go till
