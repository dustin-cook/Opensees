...
analysis.ground_motion_scale_factor = 0.5; % Scale the GM amplitude
...
analysis.collapse_drift = 0.12; % stop analysis at this drift and say collapse
...
if strcmp(analysis.proceedure,'test')
    ...
    analysis.damp_ratio_list = [0.02]; % Analysis damping ratio
...
elseif strcmp(analysis.proceedure,'Pushover')
    ...
    analysis.pushover_drift_list_x = [0.008, 0.008]; % Drift limit where the pushover will go till
    analysis.pushover_drift_list_z = [0.0013 0.0013];
