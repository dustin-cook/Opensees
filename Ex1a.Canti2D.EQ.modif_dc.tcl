...
# nodal masses:
mass 2 1 0. 0.;			   # node#, Mx My Mz, Mass=Weight/g.
...
# connectivity:
element elasticBeamColumn 1 1 2 3600 3225 8333 1;	# element elasticBeamColumn $eleTag $iNode $jNode $A $E $Iz $transfTag
...
timeSeries Linear 1
pattern Plain 1 1 {
   load 2 0. -386. 0.;			    # node#, FX FY MZ --  superstructure-weight
}
