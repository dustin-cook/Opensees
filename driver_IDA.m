    ...
    for i = 1:length(IDA_scale_factors)
        for gms = 1:height(gm_set_table)   
            ...
            if exist(outputs_file,'file')
                ...
                id_2 = id_2 + 1;
                missing_ida.scale(id_2,1) = IDA_scale_factors(i);
                missing_ida.gm_set_id(id_2,1) = gm_set_table.set_id(gms);
                missing_ida.gm_set_pair_id(id_2,1) = gm_set_table.pair(gms);
            end
        end
    end
