...
source outputs/ICBS_ns_wall_elastic/model.tcl 
source outputs/ICBS_ns_wall_elastic/eigen.tcl 
source outputs/ICBS_ns_wall_elastic/loads.tcl 
source outputs/ICBS_ns_wall_elastic/recorders.tcl 
## ANALYSIS DEFINITION 
wipeAnalysis 
# Define Constraints 
constraints Plain 
